// Seed script to populate positions table
// Run with: node scripts/seed-positions.js (from backend root)
...
const POSITIONS = [
  ...
  "Accounting Staff I",
  "Accounting Staff II",
  "Accounting Staff III",
  "Accounting Staff IV",
  "Accounting Staff V",
  "Administrative Support I",
  "Administrative Support X",
  "Administrative Support XI",
  "Administrative Support XII",
  "Administrative Support XIII",
  ...
  "Administrative Support VIII",
  "Administrative Support IX",
...
async function seedPositions() {
  ...
  try {
    ...
    const [result] = await db.query(
      `INSERT IGNORE INTO positions (position_name) VALUES ${placeholders}`,
      POSITIONS,
    );

    console.log(
      `✔  Positions seeded successfully: ${result.affectedRows} new positions inserted`,
    );
    ...
    console.log(`✔  Total positions in database: ${total}`);

    process.exit(0);
  } catch (err) {
    console.error("Error seeding positions:", err.message);
    process.exit(1);
  }
}
